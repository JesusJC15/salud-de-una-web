                      ...
                      <tr key={item.id} className="hover:bg-slate-50/60 transition-colors">
                        ...
                        <td className="px-4 py-3">
                          <button
                            ...
                            className="rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-bold text-slate-600 hover:border-teal-300 hover:text-teal-600 disabled:opacity-50"
                          >

      ...
      <body className="antialiased">
        <ErrorBoundary>
          <Auth0ClientProvider>
            ...
            <div className="gradient-bg dark:bg-background-dark flex min-h-screen flex-col">
              {/* Background decorations - positioned absolutely to avoid affecting viewport coordinate system */}
              <div className="pointer-events-none absolute inset-0 z-0 overflow-hidden">
                ...
                <div className="absolute bottom-10 left-1/2 h-64 w-64 translate-x-[-50%] rounded-full bg-aquamarine/5 blur-2xl"></div>
              </div>
